...
#   $CORPUS/reference/media/media_dl, $CORPUS/http_harvest, $CORPUS/arks
#   $MEDIA/props, $MEDIA/props
#   ~/.local/share/PalaceChat/Media, $MEDIA/colosseum-bgs
# These are the local mirrors of the Balamb Garden media server (the corpus
# harvest under $CORPUS holds almost no backgrounds).
