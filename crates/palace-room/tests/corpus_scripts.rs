...
//!
//! `~/palace-corpus/scripts_clean/by_script/<payload>_hs<idx>.txt` holds 2,400 scripts
//! produced by an independent Python extractor
//! (`~/palace-corpus/tools/extract_scripts.py`) from the 799 payloads in
//! `~/palace-corpus/payloads_all/`. This test re-extracts them through `palace-room`
