...
//!
//! ```text
//! PALACE_PROP_CORPUS="$HOME/colosseum/props_harvested:$HOME/colosseum/pserver.prp" \
...
//! `.prp` roster is read with the container layout from `~/palace-corpus/PRP-FORMAT.md`;
